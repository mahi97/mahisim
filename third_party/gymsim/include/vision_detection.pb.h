...
class Vision_DetectionFrame :
 ...
 public:
  ...
  enum : int {
    kRobotsYellowFieldNumber = 1,
    kRobotsBlueFieldNumber = 2,
    kBallFieldNumber = 3,
  };
  ...
  bool has_ball() const;
  void clear_ball();
  const ::Vision_DetectionBall& ball() const;
  ::Vision_DetectionBall* release_ball();
  ::Vision_DetectionBall* mutable_ball();
  void set_allocated_ball(::Vision_DetectionBall* ball);
...
// optional .Vision_DetectionBall ball = 3;
inline bool Vision_DetectionFrame::has_ball() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Vision_DetectionFrame::clear_ball() {
  if (ball_ != nullptr) ball_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::Vision_DetectionBall& Vision_DetectionFrame::ball() const {
  const ::Vision_DetectionBall* p = ball_;
  // @@protoc_insertion_point(field_get:Vision_DetectionFrame.ball)
  return p != nullptr ? *p : *reinterpret_cast<const ::Vision_DetectionBall*>(
      &::_Vision_DetectionBall_default_instance_);
}
inline ::Vision_DetectionBall* Vision_DetectionFrame::release_ball() {
  // @@protoc_insertion_point(field_release:Vision_DetectionFrame.ball)
  _has_bits_[0] &= ~0x00000001u;
  ::Vision_DetectionBall* temp = ball_;
  ball_ = nullptr;
  return temp;
}
inline ::Vision_DetectionBall* Vision_DetectionFrame::mutable_ball() {
  _has_bits_[0] |= 0x00000001u;
  if (ball_ == nullptr) {
    auto* p = CreateMaybeMessage<::Vision_DetectionBall>(GetArenaNoVirtual());
    ball_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Vision_DetectionFrame.ball)
  return ball_;
}
inline void Vision_DetectionFrame::set_allocated_ball(::Vision_DetectionBall* ball) {
  ...
  ball_ = ball;
  // @@protoc_insertion_point(field_set_allocated:Vision_DetectionFrame.ball)
}
