...
class Rectangle :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Rectangle) */ {
 public:
  Rectangle();
  virtual ~Rectangle();
...
class Debug_Arc :
 ...
 public:
  ...
  ::Rectangle* release_rectangle();
  ::Rectangle* mutable_rectangle();
  void set_allocated_rectangle(::Rectangle* rectangle);
...
inline const ::Point& Rectangle::point1() const {
  const ::Point* p = point1_;
  // @@protoc_insertion_point(field_get:Rectangle.point1)
  return p != nullptr ? *p : *reinterpret_cast<const ::Point*>(
      &::_Point_default_instance_);
}
inline ::Point* Rectangle::release_point1() {
  // @@protoc_insertion_point(field_release:Rectangle.point1)
  _has_bits_[0] &= ~0x00000001u;
  ::Point* temp = point1_;
  point1_ = nullptr;
  return temp;
}
inline ::Point* Rectangle::mutable_point1() {
  _has_bits_[0] |= 0x00000001u;
  if (point1_ == nullptr) {
    auto* p = CreateMaybeMessage<::Point>(GetArenaNoVirtual());
    point1_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Rectangle.point1)
  return point1_;
}
inline void Rectangle::set_allocated_point1(::Point* point1) {
  ...
  point1_ = point1;
  // @@protoc_insertion_point(field_set_allocated:Rectangle.point1)
}
...
inline const ::Point& Rectangle::point2() const {
  const ::Point* p = point2_;
  // @@protoc_insertion_point(field_get:Rectangle.point2)
  return p != nullptr ? *p : *reinterpret_cast<const ::Point*>(
      &::_Point_default_instance_);
}
inline ::Point* Rectangle::release_point2() {
  // @@protoc_insertion_point(field_release:Rectangle.point2)
  _has_bits_[0] &= ~0x00000002u;
  ::Point* temp = point2_;
  point2_ = nullptr;
  return temp;
}
inline ::Point* Rectangle::mutable_point2() {
  _has_bits_[0] |= 0x00000002u;
  if (point2_ == nullptr) {
    auto* p = CreateMaybeMessage<::Point>(GetArenaNoVirtual());
    point2_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Rectangle.point2)
  return point2_;
}
inline void Rectangle::set_allocated_point2(::Point* point2) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete point2_;
  }
  ...
  point2_ = point2;
  // @@protoc_insertion_point(field_set_allocated:Rectangle.point2)
}
...
inline const ::Rectangle& Debug_Arc::rectangle() const {
  const ::Rectangle* p = rectangle_;
  // @@protoc_insertion_point(field_get:Debug_Arc.rectangle)
  return p != nullptr ? *p : *reinterpret_cast<const ::Rectangle*>(
      &::_Rectangle_default_instance_);
}
inline ::Rectangle* Debug_Arc::release_rectangle() {
  // @@protoc_insertion_point(field_release:Debug_Arc.rectangle)
  _has_bits_[0] &= ~0x00000001u;
  ::Rectangle* temp = rectangle_;
  rectangle_ = nullptr;
  return temp;
}
inline ::Rectangle* Debug_Arc::mutable_rectangle() {
  _has_bits_[0] |= 0x00000001u;
...
inline void Debug_Arc::set_allocated_rectangle(::Rectangle* rectangle) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rectangle_;
  }
