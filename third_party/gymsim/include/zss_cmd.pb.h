...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Robot_Status::robot_id() const {
  // @@protoc_insertion_point(field_get:Robot_Status.robot_id)
  return robot_id_;
}
inline void Robot_Status::set_robot_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
  robot_id_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Robots_Command::delay() const {
  // @@protoc_insertion_point(field_get:Robots_Command.delay)
  return delay_;
}
inline void Robots_Command::set_delay(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
  delay_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Robot_Command::robot_id() const {
  // @@protoc_insertion_point(field_get:Robot_Command.robot_id)
  return robot_id_;
}
inline void Robot_Command::set_robot_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
  robot_id_ = value;
